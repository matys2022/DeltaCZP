...
public class StudentAccountXmlSerializationService implements Serialization {

    private final XmlMapper xmlMapper;

    public StudentAccountXmlSerializationService() {
    ...
    public Object deserialize(String serializable) {
        try{
            return this.xmlMapper.readValue(serializable, StudentAccount.class);
        }catch(Exception e){
